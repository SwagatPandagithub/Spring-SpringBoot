...
public class CustomerDaoImpl implements iCustomerDao{
	...
	//DataSource object(as dependent class) is created in this class (target class)
	  ...
	  public CustomerDaoImpl(DataSource dataSource) { this.dataSource = dataSource;
	  System.out.
	  println("customerdaoImpl class is instantiated and datasource object is injected in DAO impl class..."
